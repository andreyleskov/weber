defmodule Weber.Tests.Unit.Word do
  ...
  test "word can be created" do
    ...
    assert Word.execute(%Word{}, %Word.Commands.Create{word: "testMe", description: "En"}) ==
        %Word.Events.Created{word: "testMe", description: "En"}
  ...
  test "Given word created When applied Then word normal form is set" do
    assert Word.apply(%Word{}, %Word.Events.Created{word: "testMe", description: "En"}) ==
      %Word{word: "testMe", description: "En"}
  end
